...
const AnimatedSvg = () => {
  ...
  React.useEffect(() => {
    ...
    const windowInnerElements = [
      windowInner1,
      windowInner2,
      windowInner3,
      windowInner4,
    ];
    const arrow3Dots = [dot1, dot2, dot3, arrow];
    ...
    tl.current
      ...
      .to(
        [ground, groundShadow],
        { duration: 1, y: "-=220", stagger: 0.2 },
        "-=0.5"
      )
      .to(
        phone,
        { duration: 0.5, autoAlpha: 1, y: "+=100", x: "-=100" },
        "-=1.5"
      )
      ...
      .fromTo(
        window,
        { duration: 1, autoAlpha: 0, x: "-=50" },
        { autoAlpha: 1, x: "+=50" }
      )
      .fromTo(
        windowInnerElements,
        { duration: 1.2, autoAlpha: 0, x: "-=30" },
        { autoAlpha: 1, x: "+=30" },
        "+=0.3"
      )
      .fromTo(
